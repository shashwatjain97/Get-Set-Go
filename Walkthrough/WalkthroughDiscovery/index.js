...
export default class WalkthroughDiscovery extends Component {
  ...
  render() {
    ...
    const imageBG =
      "https://antiqueruby.aliansoftware.net//Images/walkthrough/ic_back_wttwentyseven.png";
          ...
          <View style={styles.modalStyle}>
            <View style={styles.popupBgImage}>
              ...
              <View style={styles.socialButtons}>
                <Text style={styles.readyToGetStarted}>
                  READY TO GET STARTED?
                </Text>

                <TouchableOpacity
                  style={styles.lonInWithFbBg}
                  onPress={() => alert("LogIn with Facebook")}
                >
                  <FontAwesome name="facebook" size={20} color="white" />
                  <Text style={styles.logInWithFbTwitterText}>
                    Login with Facebook
                  </Text>
                </TouchableOpacity>

                <TouchableOpacity
                  style={styles.lonInWithTwitterBg}
