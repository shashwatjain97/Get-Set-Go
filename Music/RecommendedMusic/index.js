...
export default class RecommendedMusic extends React.Component {
  ...
  componentWillMount() {
    AsyncStorage.multiGet(["SongCurrentTime"]).then(data => {
      if (data[0][1] != null) {
        songTime = data[0][1];
    ...
    BackHandler.addEventListener("hardwareBackPress", function() {
      ...
      AsyncStorage.removeItem("SongCurrentTime");
  ...
  asyncHandle() {
    AsyncStorage.multiSet([
      ["SongCurrentTime", this.state.currentTime.toString()]
    ]);
  }
      ...
      <TouchableOpacity>
        {rowData.is_popup_open.toString() == "true" ? (
          <View
            style={[
              styles.listDropDown,
              rowData.id == lengthFirst.id
                ? {
                    right: Metrics.HEIGHT * 0.05,
                    bottom: Metrics.HEIGHT * 0.005
                  }
                : { right: Metrics.HEIGHT * 0.05, top: Metrics.HEIGHT * 0.005 }
            ]}
          >
        ...
        >
          <View style={styles.listTrackInfoImg}>
            <Image source={rowData.musicImg} style={styles.listTrackImage} />
          ...
          <Header androidStatusBarColor={"transparent"} style={styles.header}>
            ...
            <Body style={styles.body}>
              <Text
                style={[
                  styles.textTitle,
                  { fontSize: Fonts.moderateScale(14), marginBottom: 2 }
                ]}
              >
                Im not Afraid
              </Text>
              <Text
                style={[
                  styles.textTitle,
                  { fontSize: Fonts.moderateScale(12), marginTop: 1.5 }
                ]}
              >
                Florian & Friends
              </Text>
          ...
          <TouchableOpacity onPress={() => this.backHandleMusic()}>
            <ImageBackground style={styles.musicImg} source={Images.musicBg}>
              <Video
                ...
                source={{
                  uri:
                    "https://api.soundcloud.com/tracks/254196631/stream?client_id=8a754483a114344c70ab15f20a5035ab3"
                }}
                muted={false}
                resizeMode="cover"
                repeat={false}
              ...
              <View style={styles.musicSliderView}>
                ...
                >
                  <Text style={styles.musicTimeTxt}>
                    {formattedTime(this.state.songDuration)}
                  </Text>
                </View>
              </View>
            </ImageBackground>
            ...
            <View style={{ flexDirection: "row" }}>
              ...
              <View style={styles.detailsTxtView}>
                <Text
                  style={[
                    styles.detailsTxt,
                    { fontSize: Fonts.moderateScale(14), color: "#272727" }
                  ]}
                >
                  Paulina Fuchs
                </Text>
                <Text
                  style={[
                    styles.detailsTxt,
                    { fontSize: Fonts.moderateScale(12), color: "#808080" }
                  ]}
                >
                  12 min ago
                </Text>
              ...
              >
                <MaterialIcons name={"more-vert"} size={30} color="#e3e3e3" />
              </TouchableOpacity>
            </View>
          </View>
