...
class HomeScreen extends React.Component {
  ...
  componentWillUnmount() {
    ...
    console.log("false");
    AsyncStorage.multiSet([["FirstAntiqueruby", "false"]]);
  }
          ...
          <View style={styles.container}>
            <View style={styles.btnsec}>
              <TouchableOpacity
                ...
                onPress={() => that.props.navigation.navigate("SignIn_01")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_02")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_03")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_04")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_05")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_06")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_07")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_08")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_09")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_10")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_11")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_12")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("SignIn_13")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                ...
                onPress={() => that.props.navigation.navigate("SignIn_14")}
              >
