          ...
          <View style={styles.container}>
            <View style={styles.btnsec}>
              <TouchableOpacity
                ...
                onPress={() => that.props.navigation.navigate("Profile_01")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_02")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_03")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_04")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_05")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_06")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_07")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_08")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_09")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_10")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_11")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_12")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_13")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_14")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_15")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_16")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_17")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_18")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_19")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_20")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_21")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_22")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_23")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_24")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_25")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_26")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_27")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_28")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Profile_29")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                ...
                onPress={() => that.props.navigation.navigate("Profile_30")}
              >
