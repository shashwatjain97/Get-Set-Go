          ...
          <View style={styles.container}>
            <View style={styles.btnsec}>
              <TouchableOpacity
                ...
                onPress={() => that.props.navigation.navigate("Social_01")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_02")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_03")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_04")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_05")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_06")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_07")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_08")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_09")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_10")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_11")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_12")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_13")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_14")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_15")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_16")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_18")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_19")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Social_20")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                ...
                onPress={() => that.props.navigation.navigate("Social_21")}
              >
