          ...
          <View style={styles.container}>
            <View style={styles.btnsec}>
              <TouchableOpacity
                ...
                onPress={() => that.props.navigation.navigate("Drawer_01")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_02")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_03")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_04")}
              >
                <Text style={styles.buttonText}>
                  Drawer Social Notification
                </Text>
              </TouchableOpacity>
            </View>
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_05")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_06")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_07")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_08")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_09")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_10")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_11")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_12")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_13")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_14")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_15")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_16")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_17")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_18")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_19")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_20")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_21")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_22")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_23")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_24")}
              >
                <Text style={styles.buttonText}>
                  Drawer Expanding with Swiper
                </Text>
              </TouchableOpacity>
            </View>
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_25")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_26")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_27")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_28")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                style={styles.btnStyle}
                onPress={() => that.props.navigation.navigate("Drawer_29")}
              >
            ...
            <View style={styles.btnsec}>
              <TouchableOpacity
                ...
                onPress={() => that.props.navigation.navigate("Drawer_30")}
              >
